  ...
  20 PRINT INK 4;" \ : \:    \:'\'' \:'\'.\ :   \:'\': \:'\': \:.\.: \:'\':       \''\:    \:'  \:  \'.   \: \.: \:.\.:  \:  \:.\.:        \:    \:.\.. \:  \ :   \: \'. \: \ :  \:  \: \ :"; INK 6;AT 21,5;" \* por \{vi}$R\{vn}         R.Bernat."
  25 PRINT AT 15,3;"Quien empieza tu o yo? (t/y).": GOSUB 2800: PRINT AT 15,3;"                             ": GO SUB 2500
 ...
 450 IF a$="y" THEN GO TO 700: END IF
 480 LET M(5,1)=1: LET xp=5: LET yp=1: LET color=1: GO SUB 3000
 490 GO TO 700
 500 PRINT AT 12,20; INK 4; FLASH 1;"PENSANDO ": LET pp=0
 510 LET p=0
 520 FOR i=1 TO 8
 ...
 640 IF j=48 THEN PRINT AT 12,20;"Empate": GO TO 3600: END IF
 700 REM ********************************  TU JUEGAS *******************************************
 701 PRINT INK 4;AT 12,20;"TU MUEVES"
 710 GOSUB 2700: LET x=VAL a$
 720 IF x<1 OR x>8 THEN GO TO 710: END IF
 725 LET color=2: GO SUB 2000: IF y>6 THEN PRINT AT 12,20;"No valido": GO TO 710: END IF
 730 LET yp=y: LET xp=x: LET color=2: GO SUB 3000
 740 LET M(xp,yp)=2: LET j=j+1
 750 REM veo si ganas
 760 GO SUB 1030
 770 IF psp>=30 THEN GO TO 3550: END IF
 780 IF j=48 THEN PRINT OVER 1;AT 21,0;"              ...fin": GO TO 3600: END IF
 790 GO TO 500
...
2700 REM Espera por una tecla en vez de usar INPUT
2710 LET a$=INKEY$: IF a$="" THEN GO TO 2710: END IF
2720 RETURN
2800 GOSUB 2700: IF a$ <> "t" AND a$ <> "y" THEN GOTO 2800: END IF
2810 RETURN
...
3550 PRINT INK 2;"\::\::\:: \::\  \::   \::\::\:: \::\::\:: \::\'.\  \:: \::\::\:: \::\::\::\  \  \  \::\  \  \::\  \::\  \  \  \::\  \  \  \::\  \::\  \::\  \'.\::\  \::\  \::\  \'.\..\  \  \  \  \::\  \  \:: \::   \:: \:: \::\::\::\  \::\  \  \::\  \::\::\::\  \  \  \'.   \::  \::\::\::\  \  \  \::\::\::\  \::\  \::\  \::\  \  \::\  \::\  \::\  \::\::\::"
3600 PRINT "Te juegas otra? (s/n)": GOSUB 2700: IF a$="s" THEN GO TO 6: END IF: IF a$<>"n" THEN GOTO 3600: END IF
