...
TMP_ARR_PTR:
	    ...
	    ENDP
	    pop namespace
#line 100 "zx48k/let_array_local_const0.bas"
...
#line 139 "/zxbasic/src/arch/zx48k/library-asm/arrayalloc.asm"
	    pop namespace
#line 101 "zx48k/let_array_local_const0.bas"
...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 102 "zx48k/let_array_local_const0.bas"
...
__MEM_BLOCK_JOIN:  ; Joins current block (pointed by HL) with next one (pointed by DE). HL->length already in BC
	    ...
	    ENDP
	    pop namespace
#line 103 "zx48k/let_array_local_const0.bas"
...
__PRINTU_LOOP:
	    ...
	    ENDP
	    pop namespace
#line 104 "zx48k/let_array_local_const0.bas"
...
__PRINT_STR:
	    ...
	    ENDP
	    pop namespace
#line 105 "zx48k/let_array_local_const0.bas"
.LABEL.__LABEL6:
	DEFB 00h
	DEFB 00h
	DEFB 01h
