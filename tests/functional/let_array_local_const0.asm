...
TMP_ARR_PTR:
	    ...
	    ENDP
	    pop namespace
#line 99 "let_array_local_const0.bas"
...
#line 139 "/zxbasic/src/arch/zx48k/library-asm/arrayalloc.asm"
	    pop namespace
#line 100 "let_array_local_const0.bas"
...
__MEM_BLOCK_JOIN:  ; Joins current block (pointed by HL) with next one (pointed by DE). HL->length already in BC
	    ...
	    ENDP
	    pop namespace
#line 101 "let_array_local_const0.bas"
...
__PRINTU_LOOP:
	    ...
	    ENDP
	    pop namespace
#line 102 "let_array_local_const0.bas"
...
__PRINT_STR:
	    ...
	    ENDP
	    pop namespace
#line 103 "let_array_local_const0.bas"
.LABEL.__LABEL6:
	DEFB 00h
	DEFB 00h
	DEFB 01h
