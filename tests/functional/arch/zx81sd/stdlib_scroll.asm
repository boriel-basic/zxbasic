...
.core.__END_PROGRAM:
	...
	halt
_ScrollRight:
#line 37 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
		push namespace core
		PROC
...
AND8:
		...
		ENDP
		pop namespace
#line 197 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
_ScrollRight__leave:
	ret
_ScrollLeft:
#line 205 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
		push namespace core
		PROC
...
AND8:
		...
		ENDP
		pop namespace
#line 366 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
_ScrollLeft__leave:
	ret
_ScrollUp:
#line 375 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
		push namespace core
		PROC
...
EMPTYLINE:
		...
		ENDP
		pop namespace
#line 545 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
_ScrollUp__leave:
	ret
_ScrollDown:
#line 554 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
		push namespace core
		PROC
		LOCAL LOOP1, MASK1, MASK2, COLUMNN, NEQ1
		LOCAL AND1, AND2, AND3, AND4, AND5, AND6, AND7, AND8
...
EMPTYLINE:
		...
		ENDP
		pop namespace
#line 725 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
_ScrollDown__leave:
	ret
_ScrollRightAligned:
#line 736 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
		push namespace core
		PROC
		LOCAL LOOP1
		LOCAL LOOP2
...
LOOP2:
		...
		ENDP
		pop namespace
#line 792 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
_ScrollRightAligned__leave:
	ret
_ScrollLeftAligned:
#line 803 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
		push namespace core
		PROC
		LOCAL LOOP1
		LOCAL LOOP2
...
LOOP2:
		...
		ENDP
		pop namespace
#line 860 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
_ScrollLeftAligned__leave:
	ret
_ScrollUpAligned:
#line 871 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
		push namespace core
		PROC
		LOCAL LOOP1
		pop hl
...
LOOP_START:
		...
		ENDP
		pop namespace
#line 946 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
_ScrollUpAligned__leave:
	ret
_ScrollDownAligned:
#line 957 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
		push namespace core
		PROC
		LOCAL LOOP1
		pop hl
...
LOOP_START:
		...
		ENDP
		pop namespace
#line 1032 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
...
#line 1037 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
...
leave:
	    ...
	    ENDP
	    pop namespace
#line 1038 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
#line 1 "/zxbasic/src/lib/arch/zx81sd/runtime/pixel_addr.asm"
...
PIXEL_ADDR:
    ...
    ; -- L: fila de carácter (bits 7-5) + columna de byte (bits 4-0) --
	    ...
	    ENDP
	    pop namespace
#line 1039 "/zxbasic/src/lib/arch/zx81sd/stdlib/scroll.bas"
	END
