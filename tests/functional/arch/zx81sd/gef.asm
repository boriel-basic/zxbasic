...
.core.__END_PROGRAM:
	...
	halt
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zx48k/runtime/cmp/gef.asm"
...
__U32TOFREG_END:
	    ...
	    ENDP
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zx48k/runtime/cmp/gef.asm"
...
__FTOU8:	; Converts float in C ED LH to Unsigned byte in A
	    ...
	    ret
	    pop namespace
#line 3 "/zxbasic/src/lib/arch/zx48k/runtime/cmp/gef.asm"
...
; Tamaño total del bloque de sysvars: $91 bytes
	...
	SCR_SIZE            EQU (SCR_ROWS << 8) + SCR_COLS
	    pop namespace
#line 40 "/zxbasic/src/lib/arch/zx81sd/runtime/fp_calc.asm"
...
L247D_SAVE:
	    ...
	    ret
	    pop namespace
#line 12 "/zxbasic/src/lib/arch/zx81sd/runtime/stackf.asm"
	    push namespace core
	; ---------------------------------------------------------------------------
...
__FPSTACK_POP:
	    ...
	    ret
	    pop namespace
#line 4 "/zxbasic/src/lib/arch/zx48k/runtime/cmp/gef.asm"
	; -------------------------------------------------------------
