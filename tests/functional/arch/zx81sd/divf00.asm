...
.core.__END_PROGRAM:
	...
	halt
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zx81sd/runtime/arith/divf.asm"
...
__FPSTACK_POP:
	    ...
	    ret
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zx81sd/runtime/arith/divf.asm"
	; -------------------------------------------------------------
...
__DIVBYZERO:
	    ...
	    ENDP
	    pop namespace
#line 17 "arch/zx81sd/divf00.bas"
...
__FP_PUSH_REV:
	    ...
	    ret
	    pop namespace
#line 18 "arch/zx81sd/divf00.bas"
...
__STOREF:	; Stores the given FP number in A EDCB at address HL
	    ...
	    ret
	    pop namespace
#line 19 "arch/zx81sd/divf00.bas"
	END
