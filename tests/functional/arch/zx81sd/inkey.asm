...
.core.__END_PROGRAM:
	...
	halt
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zx81sd/runtime/io/keyboard/inkey.asm"
...
; Tamaño total del bloque de sysvars: $91 bytes
	...
	SCR_SIZE            EQU (SCR_ROWS << 8) + SCR_COLS
	    pop namespace
#line 7 "/zxbasic/src/lib/arch/zx81sd/runtime/error.asm"
	    push namespace core
...
__MEM_SUBTRACT:
	    ...
	    ENDP
	    pop namespace
#line 12 "/zxbasic/src/lib/arch/zx81sd/runtime/io/keyboard/inkey.asm"
#line 1 "/zxbasic/src/lib/arch/zx81sd/runtime/io/keyboard/keyscan.asm"
	; ---------------------------------------------------------------------------
...
NOT_FOUND:
	    ...
	    ENDP
	    pop namespace
#line 13 "/zxbasic/src/lib/arch/zx81sd/runtime/io/keyboard/inkey.asm"
	    push namespace core
INKEY:
	    PROC
	    LOCAL __EMPTY_INKEY
