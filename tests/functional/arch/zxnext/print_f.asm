...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 18 "arch/zxnext/print_f.bas"
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/printf.asm"
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/printstr.asm"
...
__MEM_BLOCK_JOIN:  ; Joins current block (pointed by HL) with next one (pointed by DE). HL->length already in BC
	    ...
	    ENDP
	    pop namespace
#line 5 "/zxbasic/src/lib/arch/zxnext/runtime/printstr.asm"
	; PRINT command routine
...
__PRINT_STR:
	    ...
	    ENDP
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zxnext/runtime/printf.asm"
...
__FPSTACK_I16:	; Pushes 16 bits integer in HL into the FP ROM STACK
	    ...
	    jp __FPSTACK_PUSH
	    pop namespace
#line 3 "/zxbasic/src/lib/arch/zxnext/runtime/printf.asm"
	    push namespace core
__PRINTF:	; Prints a Fixed point Number stored in C ED LH
	...
	RECLAIM2 EQU 19E8h
	    ENDP
	    pop namespace
#line 19 "arch/zxnext/print_f.bas"
	END
