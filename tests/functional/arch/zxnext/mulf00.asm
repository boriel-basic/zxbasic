...
.core.__END_PROGRAM:
	...
	ret
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/arith/mulf.asm"
...
__FPSTACK_I16:	; Pushes 16 bits integer in HL into the FP ROM STACK
	    ...
	    jp __FPSTACK_PUSH
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zxnext/runtime/arith/mulf.asm"
	; -------------------------------------------------------------
...
__MULF:	; Multiplication
	    ...
	    jp __FPSTACK_POP
	    pop namespace
#line 21 "arch/zxnext/mulf00.bas"
...
__FP_PUSH_REV:
	    ...
	    ret
	    pop namespace
#line 22 "arch/zxnext/mulf00.bas"
...
__STOREF:	; Stores the given FP number in A EDCB at address HL
	    ...
	    ret
	    pop namespace
#line 23 "arch/zxnext/mulf00.bas"
	END
