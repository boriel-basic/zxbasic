...
.core.__END_PROGRAM:
	...
	ret
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/math/sin.asm"
...
__FPSTACK_I16:	; Pushes 16 bits integer in HL into the FP ROM STACK
	    ...
	    jp __FPSTACK_PUSH
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zxnext/runtime/math/sin.asm"
	    push namespace core
SIN: ; Computes SIN using ROM FP-CALC
	    ...
	    jp __FPSTACK_POP
	    pop namespace
#line 19 "arch/zxnext/math_sin.bas"
...
__STOREF:	; Stores the given FP number in A EDCB at address HL
	    ...
	    ret
	    pop namespace
#line 20 "arch/zxnext/math_sin.bas"
	END
