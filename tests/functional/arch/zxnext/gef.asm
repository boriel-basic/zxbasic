...
.core.__END_PROGRAM:
	...
	ret
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/cmp/gef.asm"
...
__U32TOFREG_END:
	    ...
	    ENDP
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zxnext/runtime/cmp/gef.asm"
...
__FTOU8:	; Converts float in C ED LH to Unsigned byte in A
	    ...
	    ret
	    pop namespace
#line 3 "/zxbasic/src/lib/arch/zxnext/runtime/cmp/gef.asm"
...
__FPSTACK_I16:	; Pushes 16 bits integer in HL into the FP ROM STACK
	    ...
	    jp __FPSTACK_PUSH
	    pop namespace
#line 4 "/zxbasic/src/lib/arch/zxnext/runtime/cmp/gef.asm"
	; -------------------------------------------------------------
