...
.core.__END_PROGRAM:
	...
	ret
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/math/tan.asm"
...
__FPSTACK_I16:	; Pushes 16 bits integer in HL into the FP ROM STACK
	    ...
	    jp __FPSTACK_PUSH
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zxnext/runtime/math/tan.asm"
	    push namespace core
TAN: ; Computes TAN using ROM FP-CALC
	    ...
	    jp __FPSTACK_POP
	    pop namespace
#line 19 "arch/zxnext/math_tan.bas"
...
__STOREF:	; Stores the given FP number in A EDCB at address HL
	    ...
	    ret
	    pop namespace
#line 20 "arch/zxnext/math_tan.bas"
	END
