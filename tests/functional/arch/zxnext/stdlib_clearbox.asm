...
_clearBox:
	...
	ld ix, 0
	add ix, sp
#line 37 "/zxbasic/src/lib/arch/zxnext/stdlib/clearbox.bas"
		PROC
...
clearbox_row_skip:
		...
		ENDP
#line 101 "/zxbasic/src/lib/arch/zxnext/stdlib/clearbox.bas"
_clearBox__leave:
	ld sp, ix
	pop ix
	exx
...
SCREEN_ATTR_ADDR:   DW 22528  ; Screen attribute address (ditto.)
	...
	pop namespace
#line 115 "/zxbasic/src/lib/arch/zxnext/stdlib/clearbox.bas"
	END
