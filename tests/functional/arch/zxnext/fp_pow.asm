...
.core.__END_PROGRAM:
	...
	ret
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/math/pow.asm"
...
__FPSTACK_I16:	; Pushes 16 bits integer in HL into the FP ROM STACK
	    ...
	    jp __FPSTACK_PUSH
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zxnext/runtime/math/pow.asm"
	; -------------------------------------------------------------
...
__POW:	; Exponentiation
	    ...
	    ENDP
	    pop namespace
#line 21 "arch/zxnext/fp_pow.bas"
...
__FP_PUSH_REV:
	    ...
	    ret
	    pop namespace
#line 22 "arch/zxnext/fp_pow.bas"
...
__STOREF:	; Stores the given FP number in A EDCB at address HL
	    ...
	    ret
	    pop namespace
#line 23 "arch/zxnext/fp_pow.bas"
	END
