...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 17 "arch/zxnext/print_u32.bas"
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/printu32.asm"
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/printi32.asm"
...
__PRINT_MINUS: ; PRINT the MINUS (-) sign. CALLER must preserve registers
	...
	__PRINT_DIGIT EQU __PRINTCHAR ; PRINTS the char in A register, and puts its attrs
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zxnext/runtime/printi32.asm"
...
__PRINTU_LOOP:
	    ...
	    ENDP
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zxnext/runtime/printu32.asm"
#line 18 "arch/zxnext/print_u32.bas"
	END
