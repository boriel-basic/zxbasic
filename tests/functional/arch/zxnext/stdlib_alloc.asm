...
.core.__END_PROGRAM:
	...
	ret
_allocate:
#line 36 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
		push namespace core
		ld b, h
		ld c, l
		jp __MEM_ALLOC
		pop namespace
#line 43 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
_allocate__leave:
	ret
_callocate:
#line 66 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
		push namespace core
		ld b, h
		ld c, l
		jp __MEM_CALLOC
		pop namespace
#line 73 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
_callocate__leave:
	ret
_deallocate:
#line 86 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
		push namespace core
		jp __MEM_FREE
		pop namespace
#line 91 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
_deallocate__leave:
	ret
_reallocate:
#line 114 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
		push namespace core
		ex de, hl
		pop hl
		ex (sp), hl
		...
		jp __REALLOC
		pop namespace
#line 125 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
_reallocate__leave:
	ret
_memavail:
#line 135 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
		push namespace core
		PROC
		LOCAL LOOP
...
LOOP:
		...
		ENDP
		pop namespace
#line 172 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
_memavail__leave:
	ret
_maxavail:
#line 181 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
		push namespace core
		PROC
		LOCAL LOOP, CONT
		ld hl, ZXBASIC_MEM_HEAP
...
CONT:
		...
		ENDP
		pop namespace
#line 228 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
_maxavail__leave:
	ret
	;; --- end of user code ---
...
__MEM_SUBTRACT:
	    ...
	    ENDP
	    pop namespace
#line 233 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
...
__MEM_CALLOC:
	    ...
	    ret
	    pop namespace
#line 234 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
...
__MEM_BLOCK_JOIN:  ; Joins current block (pointed by HL) with next one (pointed by DE). HL->length already in BC
	    ...
	    ENDP
	    pop namespace
#line 235 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
...
__REALLOC_END:
	    ...
	    ENDP
	    pop namespace
#line 236 "/zxbasic/src/lib/arch/zxnext/stdlib/alloc.bas"
	END
