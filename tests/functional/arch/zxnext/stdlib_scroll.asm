...
.core.__END_PROGRAM:
	...
	ret
_ScrollRight:
#line 26 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
		push namespace core
		PROC
...
AND8:
		...
		ENDP
		pop namespace
#line 187 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
_ScrollRight__leave:
	ret
_ScrollLeft:
#line 195 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
		push namespace core
		PROC
...
AND8:
		...
		ENDP
		pop namespace
#line 357 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
_ScrollLeft__leave:
	ret
_ScrollUp:
#line 366 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
		push namespace core
		PROC
...
EMPTYLINE:
		...
		ENDP
		pop namespace
#line 537 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
_ScrollUp__leave:
	ret
_ScrollDown:
#line 546 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
		push namespace core
		PROC
		LOCAL LOOP1, MASK1, MASK2, COLUMNN, NEQ1
		LOCAL AND1, AND2, AND3, AND4, AND5, AND6, AND7, AND8
...
EMPTYLINE:
		...
		ENDP
		pop namespace
#line 718 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
_ScrollDown__leave:
	ret
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/SP/PixelDown.asm"
	;
	; PixelDown
	; Alvin Albrecht 2002
	;
...
SCREEN_ATTR_ADDR:   DW 22528  ; Screen attribute address (ditto.)
	...
	pop namespace
#line 58 "/zxbasic/src/lib/arch/zxnext/runtime/SP/PixelDown.asm"
#line 723 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
#line 1 "/zxbasic/src/lib/arch/zxnext/runtime/SP/PixelUp.asm"
	;
	; PixelUp
	; Alvin Albrecht 2002
	;
...
leave:
	    ...
	    ENDP
	    pop namespace
#line 724 "/zxbasic/src/lib/arch/zxnext/stdlib/scroll.bas"
	END
