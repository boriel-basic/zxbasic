...
_test:
	...
	ld bc, 3
	call .core.__ALLOC_INITIALIZED_LOCAL_ARRAY_WITH_BOUNDS
	ld (ix-1), 1
	ld a, (ix-1)
	ld l, a
	ld h, 0
...
#line 142 "/zxbasic/src/lib/arch/zx48k/runtime/array/arrayalloc.asm"
	    pop namespace
#line 77 "arch/zx48k/local_array_with_bounds0.bas"
...
__DIM_NOT_EXIST:
	;   The dimension requested by the user does not exists. Return 0
	    ...
	    ENDP
	    pop namespace
#line 78 "arch/zx48k/local_array_with_bounds0.bas"
...
__MEM_BLOCK_JOIN:  ; Joins current block (pointed by HL) with next one (pointed by DE). HL->length already in BC
	    ...
	    ENDP
	    pop namespace
#line 79 "arch/zx48k/local_array_with_bounds0.bas"
.LABEL.__LABEL0:
	DEFB 00h
	DEFB 00h
	DEFB 01h
