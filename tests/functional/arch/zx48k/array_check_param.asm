...
__FNMUL2:
	    ...
	    ENDP
	    pop namespace
#line 47 "arch/zx48k/array_check_param.bas"
...
__FTOU8:	; Converts float in C ED LH to Unsigned byte in A
	    ...
	    ret
	    pop namespace
#line 48 "arch/zx48k/array_check_param.bas"
...
__LOADSTR:		; __FASTCALL__ entry
	    ...
	    ret
	    pop namespace
#line 49 "arch/zx48k/array_check_param.bas"
...
__PLOADF:
	    ...
	    jp __LOADF
	    pop namespace
#line 50 "arch/zx48k/array_check_param.bas"
	END
