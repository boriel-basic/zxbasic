...
__FNMUL2:
	    ...
	    ENDP
	    pop namespace
#line 103 "arch/zx48k/local_str_array3.bas"
...
#line 139 "/zxbasic/src/lib/arch/zx48k/runtime/arrayalloc.asm"
	    pop namespace
#line 104 "arch/zx48k/local_str_array3.bas"
...
__ARRAYSTR_FREE_MEM: ; like the above, buf also frees the array itself
	    ...
	    pop namespace
#line 105 "arch/zx48k/local_str_array3.bas"
...
__LOADSTR:		; __FASTCALL__ entry
	    ...
	    ret
	    pop namespace
#line 107 "arch/zx48k/local_str_array3.bas"
