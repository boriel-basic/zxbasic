...
_attr:
	...
	ld ix, 0
	add ix, sp
#line 28 "/zxbasic/src/lib/arch/zx48k/stdlib/attr.bas"
		push namespace core
		PROC
		LOCAL __ATTR_END
		ld e, (ix+7)
...
__ATTR_END:
		ENDP
		pop namespace
#line 49 "/zxbasic/src/lib/arch/zx48k/stdlib/attr.bas"
_attr__leave:
	ld sp, ix
	pop ix
	exx
...
_setattr:
	...
	ld ix, 0
	add ix, sp
#line 66 "/zxbasic/src/lib/arch/zx48k/stdlib/attr.bas"
		push namespace core
		PROC
		LOCAL __ATTR_END
		ld e, (ix+7)
...
__ATTR_END:
		ENDP
		pop namespace
#line 88 "/zxbasic/src/lib/arch/zx48k/stdlib/attr.bas"
_setattr__leave:
	ld sp, ix
	pop ix
	exx
	...
	ret
_attraddr:
#line 102 "/zxbasic/src/lib/arch/zx48k/stdlib/attr.bas"
		push namespace core
		pop hl
		ex (sp), hl
		ld d, a
		...
		jp __ATTR_ADDR
		pop namespace
#line 112 "/zxbasic/src/lib/arch/zx48k/stdlib/attr.bas"
_attraddr__leave:
	ret
	;; --- end of user code ---
...
__SET_SCR_PTR:  ;; Fast
	    ...
	    ENDP
	    pop namespace
#line 5 "/zxbasic/src/lib/arch/zx48k/runtime/attr.asm"
...
__SET_ATTR2:  ; Sets attr from ATTR_T to (HL) which points to the scr address
	    ...
	    ENDP
	    pop namespace
#line 117 "/zxbasic/src/lib/arch/zx48k/stdlib/attr.bas"
	END
