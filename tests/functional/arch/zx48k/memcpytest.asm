...
.core.__END_PROGRAM:
	...
	ret
_MemMove:
#line 31 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
		push namespace core
		exx
		pop hl
		exx
		...
		jp __MEMCPY
		pop namespace
#line 51 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
_MemMove__leave:
	ret
_MemCopy:
#line 67 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
		push namespace core
		exx
		pop hl
		exx
		...
		ldir
		pop namespace
#line 87 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
_MemCopy__leave:
	ret
_MemSet:
#line 100 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
		push namespace core
		pop de
		pop af
		pop bc
		...
		ldir
		pop namespace
#line 122 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
_MemSet__leave:
	ret
.LABEL.__LABEL5:
	DEFW 0005h
...
CLS:
	    ...
	    ENDP
	    pop namespace
#line 134 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 135 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
#line 1 "/zxbasic/src/lib/arch/zx48k/runtime/memcopy.asm"
	; ----------------------------------------------------------------
...
__MEMCPY2:
	    ...
	    ENDP
	    pop namespace
#line 136 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
...
__PAUSE:
	    ...
	    jp 1F3Dh  ; PAUSE_1
	    pop namespace
#line 137 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
...
__PRINT_STR:
	    ...
	    ENDP
	    pop namespace
#line 138 "/zxbasic/src/lib/arch/zx48k/stdlib/memcopy.bas"
	END
