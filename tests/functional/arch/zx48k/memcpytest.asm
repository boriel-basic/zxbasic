...
.core.__END_PROGRAM:
	...
	ret
_MemMove:
#line 31 "/zxbasic/src/arch/zx48k/library/memcopy.bas"
		push namespace core
		exx
		pop hl
		exx
...
_MemMove__leave:
	ret
_MemCopy:
#line 67 "/zxbasic/src/arch/zx48k/library/memcopy.bas"
		push namespace core
		exx
		pop hl
		exx
...
_MemCopy__leave:
	ret
_MemSet:
#line 100 "/zxbasic/src/arch/zx48k/library/memcopy.bas"
		push namespace core
		pop de
		pop af
		pop bc
...
__PRINT_STR:
	    ...
	    ENDP
	    pop namespace
#line 138 "/zxbasic/src/arch/zx48k/library/memcopy.bas"
	END
