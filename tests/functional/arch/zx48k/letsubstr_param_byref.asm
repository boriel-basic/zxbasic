...
__MEM_BLOCK_JOIN:  ; Joins current block (pointed by HL) with next one (pointed by DE). HL->length already in BC
	    ...
	    ENDP
	    pop namespace
#line 77 "arch/zx48k/letsubstr_param_byref.bas"
...
__FREE_STR:
	    ...
	    ENDP
	    pop namespace
#line 78 "arch/zx48k/letsubstr_param_byref.bas"
...
__LOADSTR:		; __FASTCALL__ entry
	    ...
	    ret
	    pop namespace
#line 79 "arch/zx48k/letsubstr_param_byref.bas"
...
__STORE_STR2:
	    ...
	    ret
	    pop namespace
#line 80 "arch/zx48k/letsubstr_param_byref.bas"
	END
