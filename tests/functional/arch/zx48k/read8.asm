...
.LABEL.__LABEL3:
	...
	call .core.COPY_ATTR
	ld a, (_c.__DATA__ + 5)
	ld de, (_c.__DATA__ + 5 + 1)
	ld bc, (_c.__DATA__ + 5 + 3)
	call .core.__PRINTF
	call .core.PRINT_EOL
.LABEL.__LABEL4:
	ld hl, _i
