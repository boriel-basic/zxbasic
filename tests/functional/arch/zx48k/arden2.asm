...
.core.__END_PROGRAM:
	...
	ret
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zx48k/runtime/chr.asm"
...
__MEM_SUBTRACT:
	    ...
	    ENDP
	    pop namespace
#line 5 "/zxbasic/src/lib/arch/zx48k/runtime/chr.asm"
	    push namespace core
