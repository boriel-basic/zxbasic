...
.LABEL.__LABEL0:
	...
	DEFB 74h
	;; --- end of user code ---
#line 1 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
...
__MEM_BLOCK_JOIN:  ; Joins current block (pointed by HL) with next one (pointed by DE). HL->length already in BC
	    ...
	    ENDP
	    pop namespace
#line 2 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 4 "/zxbasic/src/lib/arch/zx48k/runtime/over.asm"
	    push namespace core
OVER:
	    PROC
	    ld c, a ; saves it for later
...
__PRINT_TABLE:    ; Jump table for 0 .. 22 codes
	    ...
	    ENDP
	    pop namespace
#line 5 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
#line 6 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
	    push namespace core
LOAD_CODE:
...
#line 42 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
...
#line 150 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
...
#line 186 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
...
#line 197 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
	    ld a, (HEAD1)
...
LD_BYTES_NOINTER:
	    ex af, af'
	    ret
#line 280 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
	    ENDP
PRINT_TAPE_MESSAGES:
	    PROC
...
PRINT_TAPE_MSG:
	    ...
	    ret
	    ENDP
#line 334 "/zxbasic/src/lib/arch/zx48k/runtime/load.asm"
	    pop namespace
#line 33 "arch/zx48k/load03.bas"
