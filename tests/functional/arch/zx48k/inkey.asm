...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 31 "arch/zx48k/inkey.bas"
#line 1 "/zxbasic/src/lib/arch/zx48k/runtime/inkey.asm"
	; INKEY Function
...
__MEM_SUBTRACT:
	    ...
	    ENDP
	    pop namespace
#line 7 "/zxbasic/src/lib/arch/zx48k/runtime/inkey.asm"
	    push namespace core
INKEY:
	    PROC
	    LOCAL __EMPTY_INKEY
