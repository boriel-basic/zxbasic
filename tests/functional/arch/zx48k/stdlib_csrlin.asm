...
.core.__END_PROGRAM:
	...
	ret
_csrlin:
#line 26 "/zxbasic/src/lib/arch/zx48k/stdlib/csrlin.bas"
		push namespace core
		PROC
		call __LOAD_S_POSN
		ld a, d
		ENDP
		pop namespace
#line 36 "/zxbasic/src/lib/arch/zx48k/stdlib/csrlin.bas"
_csrlin__leave:
	ret
	;; --- end of user code ---
...
__SET_SCR_PTR:  ;; Fast
	    ...
	    ENDP
	    pop namespace
#line 41 "/zxbasic/src/lib/arch/zx48k/stdlib/csrlin.bas"
	END
