...
CLS:
	    ...
	    ENDP
	    pop namespace
#line 117 "arch/zx48k/subrec.bas"
...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 118 "arch/zx48k/subrec.bas"
...
__TO32BIT:  ; Converts H'L'HLB'C'AC to DEHL (Discards H'L'HL)
	    ...
	    ret
	    pop namespace
#line 119 "arch/zx48k/subrec.bas"
...
__PRINT_STR:
	    ...
	    ENDP
	    pop namespace
#line 121 "arch/zx48k/subrec.bas"
...
#line 122 "arch/zx48k/subrec.bas"
...
#line 123 "arch/zx48k/subrec.bas"
...
__SUB32:
	    ...
	    ret
	    pop namespace
#line 124 "arch/zx48k/subrec.bas"
	END
