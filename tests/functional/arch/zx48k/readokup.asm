...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 103 "arch/zx48k/readokup.bas"
...
__PRINTF:	; Prints a Fixed point Number stored in C ED LH
	...
	RECLAIM2 EQU 19E8h
	    ENDP
	    pop namespace
#line 105 "arch/zx48k/readokup.bas"
...
__DATA_ADDR:  ;; Stores current DATA ptr
	    ...
	    ENDP
	    pop namespace
#line 113 "arch/zx48k/readokup.bas"
...
__STOREF:	; Stores the given FP number in A EDCB at address HL
	    ...
	    ret
	    pop namespace
#line 114 "arch/zx48k/readokup.bas"
	END
