...
TMP_ARR_PTR:
	    ...
	    ENDP
	    pop namespace
#line 100 "arch/zx48k/let_array_local_const0.bas"
...
#line 139 "/zxbasic/src/lib/arch/zx48k/runtime/arrayalloc.asm"
	    pop namespace
#line 101 "arch/zx48k/let_array_local_const0.bas"
...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 102 "arch/zx48k/let_array_local_const0.bas"
...
__MEM_BLOCK_JOIN:  ; Joins current block (pointed by HL) with next one (pointed by DE). HL->length already in BC
	    ...
	    ENDP
	    pop namespace
#line 103 "arch/zx48k/let_array_local_const0.bas"
...
__PRINTU_LOOP:
	    ...
	    ENDP
	    pop namespace
#line 104 "arch/zx48k/let_array_local_const0.bas"
...
__PRINT_STR:
	    ...
	    ENDP
	    pop namespace
#line 105 "arch/zx48k/let_array_local_const0.bas"
.LABEL.__LABEL6:
	DEFB 00h
	DEFB 00h
	DEFB 01h
