...
__PRINT_CHR:
	    ...
	    call __SCROLL_SCR
	    pop hl
#line 92 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
2:
	    call SET_SCR_ADDR
	    jr 4f
1:
...
__PRGRAPH:
	    ...
	    bit 2, (iy + $47)
	    call nz, __BOLD
#line 139 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
	    bit 4, (iy + $47)
	    call nz, __ITALIC
#line 144 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
	    ld hl, (DFCC)
	    push hl
...
__PRINT_0Dh:        ; Called WHEN printing CHR$(13)
	    ...
	    call __SCROLL_SCR
	    pop hl
#line 209 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
1:
	    ld l, 1
__PRINT_EOL_END:
	    call SET_SCR_ADDR
...
__PRINT_BOLD2:
	    call BOLD_TMP
	    jp __PRINT_RESTART
#line 353 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
__PRINT_ITA:
	    ld hl, __PRINT_ITA2
	    jp __PRINT_SET_STATE
__PRINT_ITA2:
	    call ITALIC_TMP
	    jp __PRINT_RESTART
#line 363 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
	    LOCAL __BOLD
__BOLD:
	    push hl
	    ld hl, MEM0
...
1:
	    ...
	    ld de, MEM0
	    ret
#line 384 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
	    LOCAL __ITALIC
__ITALIC:
	    push hl
	    ld hl, MEM0
	    ...
	    ld de, MEM0
	    ret
#line 412 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
	    LOCAL __SCROLL_SCR
#line 486 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
...
PRINT_AT: ; Changes cursor to ROW, COL
	    ...
	    LOCAL __PRINT_ITA2
#line 545 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
	    LOCAL __PRINT_BOLD2
#line 551 "/zxbasic/src/lib/arch/zx48k/runtime/print.asm"
...
__REFRESH_TMP:
	    ...
	    ENDP
	    pop namespace
#line 57 "arch/zx48k/strlocal0.bas"
...
__MEM_BLOCK_JOIN:  ; Joins current block (pointed by HL) with next one (pointed by DE). HL->length already in BC
	    ...
	    ENDP
	    pop namespace
#line 58 "arch/zx48k/strlocal0.bas"
...
__PRINT_STR:
	    ...
	    ENDP
	    pop namespace
#line 60 "arch/zx48k/strlocal0.bas"
...
__STORE_STR:
	    ...
	    ret
	    pop namespace
#line 8 "/zxbasic/src/lib/arch/zx48k/runtime/pstorestr.asm"
	    push namespace core
__PSTORE_STR:
	    push ix
	    pop hl
	    ...
	    jp __STORE_STR
	    pop namespace
#line 61 "arch/zx48k/strlocal0.bas"
	END
