...
_screen:
	...
	ld hl, 0
	push hl
#line 35 "/zxbasic/src/lib/arch/zx48k/stdlib/screen.bas"
		push namespace core
		PROC
		LOCAL __SCREEN_END
		LOCAL __S_SCRNS_BC
...
__SCREEN_END:
		...
		ENDP
		pop namespace
#line 91 "/zxbasic/src/lib/arch/zx48k/stdlib/screen.bas"
	ld l, (ix-2)
	ld h, (ix-1)
	call .core.__LOADSTR
_screen__leave:
...
__FPSTACK_I16:	; Pushes 16 bits integer in HL into the FP ROM STACK
	    ...
	    jp __FPSTACK_PUSH
	    pop namespace
#line 116 "/zxbasic/src/lib/arch/zx48k/stdlib/screen.bas"
	END
