...
__SCROLL:  ; Scroll?
	        ...
	        res 1, (hl)
	        ret
#line 76 "/home/boriel/src/zxbasic/zxbasic/library-asm/print.asm"
...
__PRINT_START:
	        ...
	        call __SCROLL
#line 87 "/home/boriel/src/zxbasic/zxbasic/library-asm/print.asm"
	        call __LOAD_S_POSN
...
__PRINT_0Dh:        ; Called WHEN printing CHR$(13)
	        ...
	        call __SCROLL
#line 210 "/home/boriel/src/zxbasic/zxbasic/library-asm/print.asm"
	        call __LOAD_S_POSN
...
__PRINT_AT1_END:
	        ...
	        set 1, (hl)
	        ld a, d
#line 230 "/home/boriel/src/zxbasic/zxbasic/library-asm/print.asm"
...
PRINT_AT: ; Changes cursor to ROW, COL
	        ...
	        ld hl, __TVFLAGS
	        res 1, (hl)
#line 482 "/home/boriel/src/zxbasic/zxbasic/library-asm/print.asm"
	        jp __SAVE_S_POSN
