...
__MEM_LOOP:  ; Loads lengh at (HL, HL+). If Lenght >= BC, jump to __MEM_DONE
	        ...
	        or l
#line 165 "/home/boriel/src/zxb/trunk/library-asm/alloc.asm"
	
	        ret z ; NULL
#line 168 "/home/boriel/src/zxb/trunk/library-asm/alloc.asm"
