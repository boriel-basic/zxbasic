...
class Backend(BackendInterface):
    ...
    def _set_quad_table(self):
        ...
        self._QUAD_TABLE = {
            ICInstruction.ADDU8: ICInfo(3, Bits8._add8),
            ICInstruction.ADDI8: ICInfo(3, Bits8._add8),
            ...
            ICInstruction.SUBI8: ICInfo(3, Bits8._sub8),
            ICInstruction.SUBU8: ICInfo(3, Bits8._sub8),
            ...
            ICInstruction.MULI8: ICInfo(3, Bits8._mul8),
            ICInstruction.MULU8: ICInfo(3, Bits8._mul8),
            ...
            ICInstruction.DIVU8: ICInfo(3, Bits8._divu8),
            ICInstruction.DIVI8: ICInfo(3, Bits8._divi8),
            ...
            ICInstruction.MODU8: ICInfo(3, Bits8._modu8),
            ICInstruction.MODI8: ICInfo(3, Bits8._modi8),
            ...
            ICInstruction.SHRU8: ICInfo(3, Bits8._shru8),
            ICInstruction.SHRI8: ICInfo(3, Bits8._shri8),
            ICInstruction.SHLU8: ICInfo(3, Bits8._shl8),
            ICInstruction.SHLI8: ICInfo(3, Bits8._shl8),
            ...
            ICInstruction.LTU8: ICInfo(3, Bits8._ltu8),
            ICInstruction.LTI8: ICInfo(3, Bits8._lti8),
            ...
            ICInstruction.GTU8: ICInfo(3, Bits8._gtu8),
            ICInstruction.GTI8: ICInfo(3, Bits8._gti8),
            ...
            ICInstruction.GEI8: ICInfo(3, Bits8._gei8),
            ...
            ICInstruction.EQU8: ICInfo(3, Bits8._eq8),
            ICInstruction.EQI8: ICInfo(3, Bits8._eq8),
            ...
            ICInstruction.NEU8: ICInfo(3, Bits8._ne8),
            ICInstruction.NEI8: ICInfo(3, Bits8._ne8),
            ...
            ICInstruction.ABSI8: ICInfo(2, Bits8._abs8),  # x = -x if x < 0
            ...
            ICInstruction.NEGU8: ICInfo(2, Bits8._neg8),  # x = -y
            ICInstruction.NEGI8: ICInfo(2, Bits8._neg8),  # x = -y
            ...
            ICInstruction.ANDU8: ICInfo(3, Bits8._and8),  # x = A and B
            ICInstruction.ANDI8: ICInfo(3, Bits8._and8),  # x = A and B
            ...
            ICInstruction.ORU8: ICInfo(3, Bits8._or8),  # x = A or B
            ICInstruction.ORI8: ICInfo(3, Bits8._or8),  # x = A or B
            ...
            ICInstruction.XORU8: ICInfo(3, Bits8._xor8),  # x = A xor B
            ICInstruction.XORI8: ICInfo(3, Bits8._xor8),  # x = A xor B
            ...
            ICInstruction.NOTU8: ICInfo(2, Bits8._not8),  # x = not B
            ICInstruction.NOTI8: ICInfo(2, Bits8._not8),  # x = not B
            ...
            ICInstruction.JZEROI8: ICInfo(2, Bits8._jzero8),  # if X == 0 jmp LABEL
            ICInstruction.JZEROU8: ICInfo(2, Bits8._jzero8),  # if X == 0 jmp LABEL
            ...
            ICInstruction.JNZEROI8: ICInfo(2, Bits8._jnzero8),  # if X != 0 jmp LABEL
            ICInstruction.JNZEROU8: ICInfo(2, Bits8._jnzero8),  # if X != 0 jmp LABEL
            ...
            ICInstruction.JGEZEROI8: ICInfo(2, Bits8._jgezeroi8),  # if X >= 0 jmp LABEL
            ICInstruction.JGEZEROU8: ICInfo(2, Bits8._jgezerou8),  # if X >= 0 jmp LABEL (ALWAYS TRUE)
            ...
            ICInstruction.PARAMU8: ICInfo(1, Bits8._param8),  # Push 8 bit param onto the stack
            ICInstruction.PARAMI8: ICInfo(1, Bits8._param8),  # Push 8 bit param onto the stack
            ...
            ICInstruction.FPARAMU8: ICInfo(1, Bits8._fparam8),  # __FASTCALL__ parameter
            ICInstruction.FPARAMI8: ICInfo(1, Bits8._fparam8),  # __FASTCALL__ parameter
            ...
            ICInstruction.BANDU8: ICInfo(3, Bits8._band8),  # x = A & B
            ICInstruction.BANDI8: ICInfo(3, Bits8._band8),  # x = A & B
            ICInstruction.BORU8: ICInfo(3, Bits8._bor8),  # x = A | B
            ICInstruction.BORI8: ICInfo(3, Bits8._bor8),  # x = A | B
            ICInstruction.BXORU8: ICInfo(3, Bits8._bxor8),  # x = A ^ B
            ICInstruction.BXORI8: ICInfo(3, Bits8._bxor8),  # x = A ^ B
            ICInstruction.BNOTI8: ICInfo(2, Bits8._bnot8),  # x = !A
            ICInstruction.BNOTU8: ICInfo(2, Bits8._bnot8),  # x = !A
