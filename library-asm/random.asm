...
RND:
    ...
    ld a, e ; Use a register for the higher byte for faster RR
RND_LOOP:
	dec l
	sla b
	rl c
    ...
    ; Now undo last mantissa left-shif
    ccf ; Clears flag (it was set) to insert a 0 bit -> positive number
    rra
    rr d   
    rr c
    rr b
